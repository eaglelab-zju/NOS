        ...
        for i in range(args.num_layers):
            ...
            self.convs.append(
                ONGNNConv(
                    ...
                    simple_gating=args.simple_gating,
                    tm=args.tm,
                    diff_or=args.diff_or,
                    repeats=int(args.hidden_channel / args.chunk_size),
                )
            )
    ...
    def fit(self, graph, labels, train_mask, val_mask, test_mask):
        ...
        for epoch in range(self.epochs):
            ...
            [train_acc, valid_acc, test_acc] = self.test(
                X, edge_index, labels, [self.train_mask, self.valid_mask, self.test_mask]
            )
